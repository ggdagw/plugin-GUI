...
#ifndef GGDAGW_H_INCLUDED
#define GGDAGW_H_INCLUDED
...
/** A simple rectifier */
class ggdagw : public GenericProcessor
{
public:
...
private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ggdagw);
};



#endif  // GGDAGW_H_INCLUDED
