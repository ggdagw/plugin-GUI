...
extern "C" EXPORT void getLibInfo (Plugin::LibraryInfo* info)
{
    ...
    info->name = "LatencyThreshold plugin library";
...
extern "C" EXPORT int getPluginInfo (int index, Plugin::PluginInfo* info)
{
    switch (index)
    {
        ...
        case 0:
            ...
            //For processor
            info->processor.name = "LatencyThreshold"; //Processor name shown in the GUI
            ...
            info->processor.creator = &(Plugin::createProcessor<LatencyThresholdProcessor>);
        break;
        /**
