...
#ifndef LATENCYTHRESHOLDPROCESSOREDITOR_H_INCLUDED
#define LATENCYTHRESHOLDPROCESSOREDITOR_H_INCLUDED

#include <EditorHeaders.h>
#include <AllLookAndFeels.h>
#include "LatencyThresholdProcessorContentComponent.h"
...
/**
    ...
    @see GenericEditor
*/
class LatencyThresholdProcessorEditor : public GenericEditor    //Generic Editor adds listeners for buttons and sliders.
...
public:
    ...
    LatencyThresholdProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors);

    /** The class destructor, used to deallocate memory */
    ~LatencyThresholdProcessorEditor();
...
private:
    ...
    LatencyThresholdProcessorContentComponent content;
    ...
    */
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LatencyThresholdProcessorEditor);
};

#endif // LATENCYTHRESHOLDPROCESSOREDITOR_H_INCLUDED
