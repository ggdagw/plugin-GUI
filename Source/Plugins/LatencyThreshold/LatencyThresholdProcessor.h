...
#ifndef LATENCYTHRESHOLDPROCESSOR_H_INCLUDED
#define LATENCYTHRESHOLDPROCESSOR_H_INCLUDED
...
*/
class LatencyThresholdProcessor : public GenericProcessor

{
public:
    /** The class constructor, used to initialize any members. */
    LatencyThresholdProcessor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LatencyThresholdProcessor);
};


#endif  // LATENCYTHRESHOLDPROCESSOR_H_INCLUDED
