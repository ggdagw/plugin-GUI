...
LatencyThresholdProcessorEditor::LatencyThresholdProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
LatencyThresholdProcessorEditor::~LatencyThresholdProcessorEditor()
{
}


void LatencyThresholdProcessorEditor::resized()
{
...
*/
void LatencyThresholdProcessorEditor::buttonEvent (Button* button)
{
...
*/
void LatencyThresholdProcessorEditor::sliderEvent (Slider* slider)
{
}
