...
SimpleThresholdProcessorEditor::SimpleThresholdProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
SimpleThresholdProcessorEditor::~SimpleThresholdProcessorEditor()
{
}


void SimpleThresholdProcessorEditor::resized()
{
...
*/
void SimpleThresholdProcessorEditor::buttonEvent (Button* button)
{
...
*/
void SimpleThresholdProcessorEditor::sliderEvent (Slider* slider)
{
}
