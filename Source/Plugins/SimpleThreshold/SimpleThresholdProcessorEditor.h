...
#ifndef SIMPLETHRESHOLDPROCESSOREDITOR_H_INCLUDED
#define SIMPLETHRESHOLDPROCESSOREDITOR_H_INCLUDED

#include <EditorHeaders.h>
#include <AllLookAndFeels.h>
#include "SimpleThresholdProcessorContentComponent.h"
...
/**
    ...
    @see GenericEditor
*/
class SimpleThresholdProcessorEditor : public GenericEditor    //Generic Editor adds listeners for buttons and sliders.
...
public:
    ...
    SimpleThresholdProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors);

    /** The class destructor, used to deallocate memory */
    ~SimpleThresholdProcessorEditor();
...
private:
    ...
    SimpleThresholdProcessorContentComponent content;
    ...
    */
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SimpleThresholdProcessorEditor);
};

#endif // SIMPLETHRESHOLDPROCESSOREDITOR_H_INCLUDED
