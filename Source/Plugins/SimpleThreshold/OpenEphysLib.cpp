...
extern "C" EXPORT void getLibInfo (Plugin::LibraryInfo* info)
{
    ...
    info->name = "SimpleThreshold plugin library";
...
extern "C" EXPORT int getPluginInfo (int index, Plugin::PluginInfo* info)
{
    switch (index)
    {
        ...
        case 0:
            ...
            //For processor
            info->processor.name = "SimpleThreshold"; //Processor name shown in the GUI
            ...
            info->processor.creator = &(Plugin::createProcessor<SimpleThresholdProcessor>);
        break;
        /**
