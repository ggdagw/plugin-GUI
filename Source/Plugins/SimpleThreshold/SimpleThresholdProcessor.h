...
#ifndef SIMPLETHRESHOLDPROCESSOR_H_INCLUDED
#define SIMPLETHRESHOLDPROCESSOR_H_INCLUDED
...
*/
class SimpleThresholdProcessor : public GenericProcessor

{
public:
    /** The class constructor, used to initialize any members. */
    SimpleThresholdProcessor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SimpleThresholdProcessor);
};


#endif  // SIMPLETHRESHOLDPROCESSOR_H_INCLUDED
